...
@WebAppConfiguration
public class SalesInvoiceRepoTest {
    ...
    public void testUpdate() throws Exception {
        ...
        SalesInvoice sales = new SalesInvoice.Builder(345454).invoiceID(salesInvoice.getInvoiceID())
                .date("5 May 2015").CarID(4545453).customerID(0504554544).totalPrice(10000).build();
        ...
        Assert.assertEquals(10000, salesInvoice.getTotalPrice());
